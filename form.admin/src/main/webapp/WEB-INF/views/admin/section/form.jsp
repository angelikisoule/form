	...
	<body>
		...
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
  				...
  				<li class="active">Section Form</li>
			</ol>
			<!-- Page Header -->
			<div class="row">
				<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12">
					<form:form action="." modelAttribute="section" class="form-horizontal">
						<form:hidden path="id" /><!-- In Order To persist or merge Using The Same Controller Method -->
						<div class="form-group ${requestScope['org.springframework.validation.BindingResult.section'].hasFieldErrors('name') ? 'has-error has-feedback' : ''}">
							<form:label path="name" class="col-xs-2 control-label">Name</form:label>
							<div class="col-xs-10">
								<form:input path="name" placeholder="Name" maxlength="255" class="form-control" />
								<c:if test="${requestScope['org.springframework.validation.BindingResult.section'].hasFieldErrors('name')}">
						...
						<div class="form-group ${requestScope['org.springframework.validation.BindingResult.section'].hasFieldErrors('publication') ? 'has-error' : ''}">
						...
						<div class="col-xs-10 col-xs-offset-2">
							...
							<c:if test="${not empty section.id}">
								<a class="btn btn-lg btn-primary confirm-dialog" dialog="Are You Sure You Want To Delete This Section?" href="<c:url value='/admin/section/delete/${section.id}' />" role="button">Delete Section</a>
							</c:if>
						</div>
					</form:form>
				</div>
