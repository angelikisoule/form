...
public class GreeklishConverter {
    ...
    public static String toGreeklish(String target) {
        if(target != null) {
            ...
            target = target.replace("ΐ", "i");
            target = target.replace("Ι", "I");
            target = target.replace("η", "i");
            target = target.replace("Η", "i");
            target = target.replace("υ", "u");
            target = target.replace("ΰ", "i");
            target = target.replace("ϋ", "i");
            target = target.replace("Υ", "i");
            ...
            target = target.replace("Ί", "I");
            target = target.replace("ή", "i");
            target = target.replace("Ή", "I");
            target = target.replace("ύ", "u");
            target = target.replace("Ύ", "I");
