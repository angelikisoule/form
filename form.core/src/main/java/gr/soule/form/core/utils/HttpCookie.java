...
public class HttpCookie {
     ...
     */
    public HttpCookie(String name, String value, String path, Date expiry) {
     ...
     */
    public HttpCookie(String name, String value, String domain, String path, Date expiry) {
     ...
     */
    public HttpCookie(String name, String value, String domain, String path, Date expiry, boolean isSecure) {
        this.name = name;
        this.value = value;
        ...
        if(expiry != null) { //Expiration date is specified in seconds since (UTC) epoch time, so truncate the date.
    ...
    public boolean equals(Object o) {
        ...
        HttpCookie cookie = (HttpCookie) o;
    ...
    public static class Builder {
        ...
        public HttpCookie build() {
            return new HttpCookie(name, value, domain, path, expiry, secure);
        }
    }
}
