...
public class Newspaper extends Article implements Serializable {

	private static final long serialVersionUID = 1L;
	
	/**
	 * Override The Default toString() Method
	 * @return String Representation Of Newspaper Object
	 */
	@Override
	...
	@Override
    public int hashCode() {
        return new HashCodeBuilder(883, 887) //Two Randomly Chosen Prime Numbers
